...
class Search
{
    ...
    function research(array $array, $twig, $chemin, $cat)
    {
        $menu = array(
            array(
                'href' => $chemin,
        ...
        if (($nospace_mc === "") &&
            ...
            if ($nospace_mc !== "") $query->where('description', 'like', '%' . $array['motclef'] . '%');

            if ($nospace_cp !== "") $query->where('ville', '=', $array['codepostal']);
