...
class addItem
{
    ...
    function addItemView($twig, $menu, $chemin, $categories, $departements): void
    {
    ...
    function addNewItem($twig, $menu, $chemin, $allPostVars): void
    {
        ...
        if($this->isFormError($twig, $menu, $chemin)) {
            return;
        }
        
        // on ajoute à la base et on redirige vers une page de succès
        $annonce   = new Annonce();
